...
export default function HomePage() {
  ...
  const products = [
    {
      ...
      description: 'Test je AI skills in een interactieve game. Leer de basis van prompt engineering in 15 minuten.',
      price: 'Gratis',
      priceNote: 'Level 1',
      href: '/game',
      icon: Play,
      ...
      features: [
        'Level 1 gratis spelen',
        'Directe feedback op je prompts',
    ...
    },
    {
      ...
      description: 'Word een AI-powered recruiter in 2 uur. Live training met expert, 20+ templates en certificaat.',
      price: '€297',
      priceNote: 'Eenmalig',
      href: '/workshop',
      icon: BookOpen,
  ...
  const testimonials = [
    ...
    {
      text: "Eindelijk begrijp ik hoe AI echt werkt voor recruitment. Heel praktisch!",
      name: 'Sophie Bakker',
  ...
  return (
    <div className="min-h-screen bg-[#0f0f12] text-[#f0ede8] font-sans">
      ...
      <div className="fixed bottom-[20%] -left-[200px] w-[600px] h-[600px] bg-green-500/[0.06] rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-[#9a9a9f] mb-10 leading-relaxed max-w-2xl mx-auto">
              ...
              Start gratis met de Prompt Gym of boek direct een workshop.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <a href="/workshop" className="border border-white/[0.06] text-[#f0ede8] px-8 py-4 rounded-xl font-semibold hover:border-white/[0.12] hover:bg-[#1c1c23] transition-all inline-flex items-center justify-center gap-2">
                Bekijk Workshop
      ...
      <section id="products" className="py-24">
        <div className="max-w-[900px] mx-auto px-6">
          <div className="text-center mb-16">
            <p className="font-mono text-sm text-[#f5a623] uppercase tracking-widest mb-4">Kies je training</p>
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight mb-4">
              Van beginner tot AI expert
            </h2>
            <p className="text-[#9a9a9f] max-w-xl mx-auto">
              Start gratis met de Prompt Gym, of boek direct de complete workshop.
            </p>
          </div>
        ...
        <div className="max-w-[900px] mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight">
              In 2 stappen AI-powered
            </h2>
          </div>

          <div className="relative">
            {/* Connection line */}
            <div className="absolute left-6 top-0 bottom-0 w-0.5 bg-gradient-to-b from-green-500 to-[#f5a623] hidden md:block" />
            ...
            <div className="space-y-12">
              ...
              <div className="flex gap-8 items-start">
                ...
                <div>
                  ...
                  <p className="text-[#9a9a9f] mb-3">
                    Leer de basics in 15 minuten. Gratis, interactief, en je krijgt direct bruikbare templates voor CV screening, vacatureteksten en meer.
                  </p>
              ...
              <div className="flex gap-8 items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2">Boek de Live Workshop</h3>
                  <p className="text-[#9a9a9f] mb-3">
                    Verdiep je kennis in 2 uur. Live training met een expert, 20+ kant-en-klare templates, en directe Q&A. Je gaat naar huis met skills die je morgen al gebruikt.
                  </p>
      ...
      <section className="py-24">
        <div className="max-w-[800px] mx-auto px-6">
          ...
          <div className="bg-[#1c1c23] border border-white/[0.06] rounded-2xl p-8 md:p-12 text-center relative overflow-hidden">
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-green-500 to-[#f5a623]" />
      ...
      <section className="py-24 bg-gradient-to-b from-[#16161b] to-[#0f0f12]">
        <div className="max-w-[600px] mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="/workshop" className="border border-[#f5a623] text-[#f5a623] px-8 py-4 rounded-xl font-bold text-lg inline-flex items-center justify-center gap-2 hover:bg-[#f5a623] hover:text-[#0f0f12] transition-all">
      ...
      <footer className="py-12 border-t border-white/[0.06]">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              <h4 className="font-semibold mb-4">Trainingen</h4>
              <ul className="space-y-2 text-sm text-[#6a6a70]">
                <li><a href="/game" className="hover:text-white transition">Prompt Gym (Gratis)</a></li>
                <li><a href="/workshop" className="hover:text-white transition">Live Workshop (€297)</a></li>
              </ul>
            </div>
            <div>
